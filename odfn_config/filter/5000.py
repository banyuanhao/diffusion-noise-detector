...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        ### byh end
        ann_file='test/annotations/test_for_1_category_1_class_npy_5000.json',
        backend_args=None,
...
test_evaluator = dict(
    ann_file= data_root + 'test/annotations/test_for_1_category_1_class_npy_5000.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(classes=classes),
        ### byh end
        ann_file='train/annotations/train_for_1_category_1_class_npy_5000.json',
        backend_args=None,
        data_prefix=dict(img=''),
        data_root=data_root,
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(classes=classes),
        ### byh end
        ann_file='val/annotations/val_for_1_category_1_class_npy_5000.json',
        backend_args=None,
        data_prefix=dict(img=''),
        data_root=data_root,
        pipeline=[
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file = data_root + 'val/annotations/val_for_1_category_1_class_npy_5000.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
