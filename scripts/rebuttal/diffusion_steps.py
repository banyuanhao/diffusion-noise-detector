...
for i in range(200):
    ...
    with torch.no_grad():
        ...
        out = pipe(prompt=prompt, latents = latents, num_inference_steps = steps)
        ...
        values.append(iou)
    import json
    with open(f'/home/banyh2000/odfn/scripts/rebuttal/data/generalization/steps_{steps}_{mode}.json','w') as f:
        json.dump(values,f)
