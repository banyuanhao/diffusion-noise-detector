...
for i in range(200):
    ...
    with torch.no_grad():
        ...
        out = pipe(prompt=prompt, latents = latents, eta = eta)
        ...
        values.append(iou)
    import json
    with open(f'/home/banyh2000/odfn/scripts/rebuttal/data/generalization/scheduler_{scheduler}_{mode}_{eta}.json','w') as f:
        json.dump(values,f)
